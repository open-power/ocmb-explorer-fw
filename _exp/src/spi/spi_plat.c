...
PUBLIC spi_plat_pin_driver_strength_set_fn_ptr spi_plat_pin_driver_strength_set_ptr = _spi_plat_pin_driver_strength_set;

PUBLIC BOOL _spi_plat_is_boot_quad(VOID);
PUBLIC spi_plat_is_boot_quad_fn_ptr spi_plat_is_boot_quad_ptr = _spi_plat_is_boot_quad;

PUBLIC UINT16 _spi_plat_cs_wait_get(UINT8 wait);
PUBLIC spi_plat_cs_wait_get_fn_ptr spi_plat_cs_wait_get_ptr = _spi_plat_cs_wait_get;

PUBLIC BOOL _spi_plat_wci_mode_get(VOID);
PUBLIC spi_plat_wci_mode_get_fn_ptr spi_plat_wci_mode_get_ptr = _spi_plat_wci_mode_get;

PUBLIC PMCFW_ERROR _spi_plat_flash_poll_write_erase_complete(BOOL write, UINT32 timeout);
PUBLIC spi_plat_flash_poll_write_erase_complete_fn_ptr spi_plat_flash_poll_write_erase_complete_ptr = _spi_plat_flash_poll_write_erase_complete;

PUBLIC PMCFW_ERROR _spi_plat_flash_write_pages(UINT8* src_ptr, UINT8* dst_ptr, UINT32 len, UINT32 page_size, UINT32 timeout);
PUBLIC spi_plat_flash_write_pages_fn_ptr spi_plat_flash_write_pages_ptr = _spi_plat_flash_write_pages;
...
{
    spi_plat_pin_driver_strength_set_ptr         = (spi_plat_pin_driver_strength_set_fn_ptr)((UINT32)spi_plat_pin_driver_strength_set_ptr                 - offset);
    spi_plat_is_boot_quad_ptr                    = (spi_plat_is_boot_quad_fn_ptr)((UINT32)spi_plat_is_boot_quad_ptr                                       - offset);
    spi_plat_cs_wait_get_ptr                     = (spi_plat_cs_wait_get_fn_ptr)((UINT32)spi_plat_cs_wait_get_ptr                                         - offset);
    spi_plat_wci_mode_get_ptr                    = (spi_plat_wci_mode_get_fn_ptr)((UINT32)spi_plat_wci_mode_get_ptr                                       - offset);
    spi_plat_flash_poll_write_erase_complete_ptr = (spi_plat_flash_poll_write_erase_complete_fn_ptr)((UINT32)spi_plat_flash_poll_write_erase_complete_ptr - offset);
    spi_plat_flash_write_pages_ptr               = (spi_plat_flash_write_pages_fn_ptr)((UINT32)spi_plat_flash_write_pages_ptr                             - offset);
}
