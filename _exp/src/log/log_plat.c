...
typedef PMCFW_ERROR (*log_spi_flash_partition_erase_fn_ptr)(UINT8* spi_flash_addr, UINT32 num_bytes);
PRIVATE log_spi_flash_partition_erase_fn_ptr log_spi_flash_partition_erase_ptr = _log_spi_flash_partition_erase;
#define log_spi_flash_partition_erase (*log_spi_flash_partition_erase_ptr)
...
{
    log_spi_flash_partition_erase_ptr           = (log_spi_flash_partition_erase_fn_ptr)((UINT32)log_spi_flash_partition_erase_ptr                     - offset);
}
