...
/*
** Temporary flag to disable storing/restoring DDR parameters in SPI flash 
** until discussions with IBM are complete
** Then this flag should be removed and DDR data in SPI flash enabled.
*/
#define APP_FW_TEMP_DISABLE_DDR_SPI 1
