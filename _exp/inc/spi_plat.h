...
**        #define func_name (*func_name_ptr)
*/
typedef PMCFW_ERROR (*spi_plat_pin_driver_strength_set_fn_ptr)(UINT8 port_id);
EXTERN spi_plat_pin_driver_strength_set_fn_ptr spi_plat_pin_driver_strength_set_ptr;
#define spi_plat_pin_driver_strength_set (*spi_plat_pin_driver_strength_set_ptr)

typedef BOOL (*spi_plat_is_boot_quad_fn_ptr)(VOID);
EXTERN spi_plat_is_boot_quad_fn_ptr spi_plat_is_boot_quad_ptr;
#define spi_plat_is_boot_quad (*spi_plat_is_boot_quad_ptr)

typedef UINT16 (*spi_plat_cs_wait_get_fn_ptr)(UINT8 wait);
EXTERN spi_plat_cs_wait_get_fn_ptr spi_plat_cs_wait_get_ptr;
#define spi_plat_cs_wait_get (*spi_plat_cs_wait_get_ptr)

typedef BOOL (*spi_plat_wci_mode_get_fn_ptr)(VOID);
EXTERN spi_plat_wci_mode_get_fn_ptr spi_plat_wci_mode_get_ptr;
#define spi_plat_wci_mode_get (*spi_plat_wci_mode_get_ptr)

typedef PMCFW_ERROR (*spi_plat_flash_poll_write_erase_complete_fn_ptr)(BOOL write, UINT32 timeout);
EXTERN spi_plat_flash_poll_write_erase_complete_fn_ptr spi_plat_flash_poll_write_erase_complete_ptr;
#define spi_plat_flash_poll_write_erase_complete (*spi_plat_flash_poll_write_erase_complete_ptr)

typedef PMCFW_ERROR (*spi_plat_flash_write_pages_fn_ptr)(UINT8* src_ptr, UINT8* dst_ptr, UINT32 len, UINT32 page_size, UINT32 timeout);
EXTERN spi_plat_flash_write_pages_fn_ptr spi_plat_flash_write_pages_ptr;
#define spi_plat_flash_write_pages (*spi_plat_flash_write_pages_ptr)
