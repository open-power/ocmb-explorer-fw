...
#define PMCFW_MID_DDR                           (0x0009)    /* DDR SDRAM initialization module                  */
...
#define PMCFW_MOD_NUM                           (0x0027)    /* The number of modules PMCFW supported
...
#define PMCFW_ERR_BASE_DDR                      (PMCFW_MID_DDR                  << PMCFW_ERR_MID_OFFSET)
