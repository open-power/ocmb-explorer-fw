...
/* 
** temporary work-around to allow main app to build with TWI PQM
** and flashloader to build without it, set to 1 when building flashloader 
*/
#define FLASHLOADER_BUILD                   1
