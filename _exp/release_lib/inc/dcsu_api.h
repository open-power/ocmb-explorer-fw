...
**        #define func_name (*func_name_ptr)
*/
typedef UINT32 (*dcsu_cpu_clk_freq_get_fn_ptr)(void);
EXTERN dcsu_cpu_clk_freq_get_fn_ptr dcsu_cpu_clk_freq_get_ptr;
#define dcsu_cpu_clk_freq_get (*dcsu_cpu_clk_freq_get_ptr)
