...
*     ocmb_config_guide_v29.xlsx (ibm_v29)
*     using this command:
*     
*     python ConfigGuideConv.py -gocmb_config_guide_v29.xlsx -ribm_v29
*     -pocmb_config_guide_v29.parsed -nnamespace_exp_p_a_release_047.tcl
