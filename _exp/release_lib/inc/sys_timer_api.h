...
**        #define func_name (*func_name_ptr)
*/
typedef void (*sys_timer_busy_wait_us_fn_ptr_type)(UINT32 wait_time_ns);
EXTERN sys_timer_busy_wait_us_fn_ptr_type sys_timer_busy_wait_us_fn_ptr;
#define sys_timer_busy_wait_us (*sys_timer_busy_wait_us_fn_ptr)

typedef void (*sys_timer_busy_wait_ns_fn_ptr_type)(UINT32 wait_time_ns);
EXTERN sys_timer_busy_wait_ns_fn_ptr_type sys_timer_busy_wait_ns_fn_ptr;
#define sys_timer_busy_wait_ns (*sys_timer_busy_wait_ns_fn_ptr)

typedef UINT_TIME (*sys_timer_us_to_count_fn_ptr_type)(UINT32 time_us);
EXTERN sys_timer_us_to_count_fn_ptr_type sys_timer_us_to_count_fn_ptr;
#define sys_timer_us_to_count (*sys_timer_us_to_count_fn_ptr)

typedef UINT_TIME (*sys_timer_count_to_us_fn_ptr_type)(UINT_TIME count);
EXTERN sys_timer_count_to_us_fn_ptr_type sys_timer_count_to_us_fn_ptr;
#define sys_timer_count_to_us (*sys_timer_count_to_us_fn_ptr)

typedef UINT_TIME (*sys_timer_count_to_ns_fn_ptr_type)(UINT_TIME count);
EXTERN sys_timer_count_to_ns_fn_ptr_type sys_timer_count_to_ns_fn_ptr;
#define sys_timer_count_to_ns (*sys_timer_count_to_ns_fn_ptr)

typedef UINT_TIME (*sys_timer_diff_fn_ptr_type)(UINT_TIME time1, UINT_TIME time2);
EXTERN sys_timer_diff_fn_ptr_type sys_timer_diff_fn_ptr;
#define sys_timer_diff (*sys_timer_diff_fn_ptr)
