...
*                                                                               
* Copyright (c) 2018, 2019, 2020, 2021 Microchip Technology Inc. All rights reserved. 
*                                                                               
...
*     ocmb_config_guide_mchp_v34.xlsx (mchp_v34)
*     using this command:
*     
*     python ConfigGuideConv.py -gocmb_config_guide_mchp_v34.xlsx -rmchp_v34
*     -pocmb_config_guide_mchp_v34.parsed -nnamespace_exp_p_a_release_047.tcl
...
EXTERN BOOL ocmb_cfg_RxPatAorB(UINT32 ocmb_base_addr, 
                               UINT8 * lane_bitmask_ptr);
EXTERN BOOL ocmb_cfg_det_lane_config(UINT8 pat_lane_detection, 
                                     UINT8 * lane_bitmask_ptr);
