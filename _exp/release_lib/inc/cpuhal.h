...
**        #define func_name (*func_name_ptr)
*/
typedef void (*hal_cache_L1_L2_wb_lines_fn_ptr)(void *start_ptr, UINT32 num_lines);
EXTERN hal_cache_L1_L2_wb_lines_fn_ptr hal_cache_L1_L2_wb_lines_ptr;
#define hal_cache_L1_L2_wb_lines (*hal_cache_L1_L2_wb_lines_ptr)

typedef void (*hal_cache_L1_L2_inv_lines_fn_ptr)(void *start_ptr, UINT32 num_lines);
EXTERN hal_cache_L1_L2_inv_lines_fn_ptr hal_cache_L1_L2_inv_lines_ptr;
#define hal_cache_L1_L2_inv_lines (*hal_cache_L1_L2_inv_lines_ptr)

typedef void (*hal_cache_L1_L2_wb_bytes_fn_ptr)(void *start_ptr, UINT32 num_bytes);
EXTERN hal_cache_L1_L2_wb_bytes_fn_ptr hal_cache_L1_L2_wb_bytes_ptr;
#define hal_cache_L1_L2_wb_bytes (*hal_cache_L1_L2_wb_bytes_ptr)

typedef void (*hal_cache_L1_L2_inv_bytes_fn_ptr)(void *start_ptr, UINT32 num_bytes);
EXTERN hal_cache_L1_L2_inv_bytes_fn_ptr hal_cache_L1_L2_inv_bytes_ptr;
#define hal_cache_L1_L2_inv_bytes (*hal_cache_L1_L2_inv_bytes_ptr)

typedef UINT32 (*hal_cp0_timer_freq_get_fn_ptr)(void);
EXTERN hal_cp0_timer_freq_get_fn_ptr hal_cp0_timer_freq_get_ptr;
#define hal_cp0_timer_freq_get (*hal_cp0_timer_freq_get_ptr)
...
/* CP0 Timer */
typedef  UINT32 (*hal_cp0_ref_clk_fn_ptr)(void);
EXTERN void hal_cp0_timer_init(hal_cp0_ref_clk_fn_ptr freq_ptr);
