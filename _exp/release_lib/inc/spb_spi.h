...
**        #define func_name (*func_name_ptr)
*/
typedef VOID (*spb_spi_ecc_init_fn_ptr_type)(const UINT8 port_id, const BOOL enable, const UINT32 addr_base_phys, const UINT32 size);
EXTERN spb_spi_ecc_init_fn_ptr_type spb_spi_ecc_init_fn_ptr;
#define spb_spi_ecc_init (*spb_spi_ecc_init_fn_ptr)

typedef BOOL (*spb_spi_ecc_err_check_fn_ptr_type)(const UINT8 port_id);
...
typedef void (*spb_spi_mem_addr_size_set_fn_ptr_type)(const UINT8 port_id, const UINT8 cs_id, const UINT32 mm_addr_base_phys, const UINT32 mm_addr_size);
EXTERN spb_spi_mem_addr_size_set_fn_ptr_type spb_spi_mem_addr_size_set_fn_ptr;
#define spb_spi_mem_addr_size_set (*spb_spi_mem_addr_size_set_fn_ptr)
