...
**        #define func_name (*func_name_ptr)
*/
typedef void (*spi_ctrl_init_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const spi_dev_struct * const dev_ptr);
EXTERN spi_ctrl_init_fn_ptr_type spi_ctrl_init_fn_ptr;
#define spi_ctrl_init (*spi_ctrl_init_fn_ptr)

typedef PMCFW_ERROR (*spi_ctrl_write_hw_assist_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const UINT8 *data_ptr, UINT32 len);
EXTERN spi_ctrl_write_hw_assist_fn_ptr_type spi_ctrl_write_hw_assist_fn_ptr;
#define spi_ctrl_write_hw_assist (*spi_ctrl_write_hw_assist_fn_ptr)

typedef PMCFW_ERROR (*spi_ctrl_write_read_hw_assist_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const UINT8 *data_out_ptr, UINT32 len_out, UINT8 *data_in_ptr, UINT32 len_in);
EXTERN spi_ctrl_write_read_hw_assist_fn_ptr_type spi_ctrl_write_read_hw_assist_fn_ptr;
#define spi_ctrl_write_read_hw_assist (*spi_ctrl_write_read_hw_assist_fn_ptr)

typedef PMCFW_ERROR (*spi_ctrl_write_dummy_read_hw_assist_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const UINT8 *data_out_ptr, UINT32 len_out, UINT8 *data_in_ptr, UINT32 len_in, UINT8 dummy);
EXTERN spi_ctrl_write_dummy_read_hw_assist_fn_ptr_type spi_ctrl_write_dummy_read_hw_assist_fn_ptr;
#define spi_ctrl_write_dummy_read_hw_assist (*spi_ctrl_write_dummy_read_hw_assist_fn_ptr)

typedef PMCFW_ERROR (*spi_ctrl_write_write_hw_assist_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const UINT8 *data1_ptr, UINT32 len1, const UINT8 *data2_ptr, UINT32 len2);
EXTERN spi_ctrl_write_write_hw_assist_fn_ptr_type spi_ctrl_write_write_hw_assist_fn_ptr;
#define spi_ctrl_write_write_hw_assist (*spi_ctrl_write_write_hw_assist_fn_ptr)

typedef PMCFW_ERROR (*spi_ctrl_write_mem_mapped_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const UINT8 *src_ptr, UINT8 *dst_ptr, UINT32 len);
EXTERN spi_ctrl_write_mem_mapped_fn_ptr_type spi_ctrl_write_mem_mapped_fn_ptr;
#define spi_ctrl_write_mem_mapped (*spi_ctrl_write_mem_mapped_fn_ptr)
