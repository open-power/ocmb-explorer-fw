...
*     Foxhound_RevA_Config_Guide_pdox_r0_44.xlsx (0.44)
*     using this command:
*     
*     python ConfigGuideConv.py -gFoxhound_RevA_Config_Guide_pdox_r0_44.xlsx
*     -r0.44 -pFoxhound_RevA_Config_Guide_pdox_r0_44.parsed
