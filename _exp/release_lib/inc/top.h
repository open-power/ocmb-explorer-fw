...
**        #define func_name (*func_name_ptr)
*/
typedef BOOL (*top_efuse_spi_is_quad_fn_ptr_type)(VOID);
EXTERN top_efuse_spi_is_quad_fn_ptr_type top_efuse_spi_is_quad_fn_ptr;
#define top_efuse_spi_is_quad (*top_efuse_spi_is_quad_fn_ptr)

typedef UINT32 (*top_efuse_spi_pin_driver_strength_get_fn_ptr_type)(VOID);
EXTERN top_efuse_spi_pin_driver_strength_get_fn_ptr_type top_efuse_spi_pin_driver_strength_get_fn_ptr;
#define top_efuse_spi_pin_driver_strength_get (*top_efuse_spi_pin_driver_strength_get_fn_ptr)

typedef UINT32 (*top_efuse_spi_pin_pullup_get_fn_ptr_type)(VOID);
EXTERN top_efuse_spi_pin_pullup_get_fn_ptr_type top_efuse_spi_pin_pullup_get_fn_ptr;
#define top_efuse_spi_pin_pullup_get (*top_efuse_spi_pin_pullup_get_fn_ptr)

typedef VOID (*top_spi_driver_strength_set_fn_ptr_type)(UINT32 value);
EXTERN top_spi_driver_strength_set_fn_ptr_type top_spi_driver_strength_set_fn_ptr;
#define top_spi_driver_strength_set (*top_spi_driver_strength_set_fn_ptr)

typedef VOID (*top_spi_pullup_value_set_fn_ptr_type)(UINT32 value);
EXTERN top_spi_pullup_value_set_fn_ptr_type top_spi_pullup_value_set_fn_ptr;
#define top_spi_pullup_value_set (*top_spi_pullup_value_set_fn_ptr)

typedef BOOL (*top_spi_wci_mode_get_fn_ptr_type)(VOID);
EXTERN top_spi_wci_mode_get_fn_ptr_type top_spi_wci_mode_get_fn_ptr;
#define top_spi_wci_mode_get (*top_spi_wci_mode_get_fn_ptr)
