...
**        #define func_name (*func_name_ptr)
*/
typedef UINT32 (*pmc_crc32_fn_ptr)(const UINT8 *msg_ptr, UINT32 byte_cnt, UINT32 oldchksum, BOOL init, BOOL last);
EXTERN pmc_crc32_fn_ptr pmc_crc32_ptr;
#define pmc_crc32 (*pmc_crc32_ptr)
