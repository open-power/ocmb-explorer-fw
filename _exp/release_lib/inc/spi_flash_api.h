...
typedef enum
{
    ...
    SPI_FLASH_DEV_W25Q128JW,       /* Winbond W25Q128JW */
...
**        #define func_name (*func_name_ptr)
*/
typedef PMCFW_ERROR (*spi_flash_init_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, spi_flash_dev_enum dev);
EXTERN spi_flash_init_fn_ptr_type spi_flash_init_fn_ptr;
#define spi_flash_init (*spi_flash_init_fn_ptr)

typedef PMCFW_ERROR (*spi_flash_dev_info_get_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, spi_flash_dev_enum *dev_ptr, spi_flash_dev_info_struct *dev_info_ptr);
EXTERN spi_flash_dev_info_get_fn_ptr_type spi_flash_dev_info_get_fn_ptr;
#define spi_flash_dev_info_get (*spi_flash_dev_info_get_fn_ptr)

typedef PMCFW_ERROR (*spi_flash_vendor_ids_get_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, UINT8 *manuf_id, UINT16 *dev_id);
EXTERN spi_flash_vendor_ids_get_fn_ptr_type spi_flash_vendor_ids_get_fn_ptr;
#define spi_flash_vendor_ids_get (*spi_flash_vendor_ids_get_fn_ptr)

typedef PMCFW_ERROR (*spi_flash_sector_params_get_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const UINT8 *addr_ptr, UINT8 **sector_ptr, UINT32 *len);
EXTERN spi_flash_sector_params_get_fn_ptr_type spi_flash_sector_params_get_fn_ptr;
#define spi_flash_sector_params_get (*spi_flash_sector_params_get_fn_ptr)

typedef PMCFW_ERROR (*spi_flash_subsector_params_get_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const UINT8 *addr_ptr, UINT8 **sector_ptr, UINT32 *len);
EXTERN spi_flash_subsector_params_get_fn_ptr_type spi_flash_subsector_params_get_fn_ptr;
#define spi_flash_subsector_params_get (*spi_flash_subsector_params_get_fn_ptr)

typedef PMCFW_ERROR (*spi_flash_read_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const UINT8 *src_ptr, UINT8 *dst_ptr, UINT32 len);
EXTERN spi_flash_read_fn_ptr_type spi_flash_read_fn_ptr;
#define spi_flash_read  (*spi_flash_read_fn_ptr)

typedef PMCFW_ERROR (*spi_flash_write_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, const UINT8 *src_ptr, UINT8 *dst_ptr, UINT32 len);
EXTERN spi_flash_write_fn_ptr_type spi_flash_write_fn_ptr;
#define spi_flash_write (*spi_flash_write_fn_ptr)
...
typedef PMCFW_ERROR (*spi_flash_write_complete_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, BOOL *complete);
EXTERN spi_flash_write_complete_fn_ptr_type spi_flash_write_complete_fn_ptr;
#define spi_flash_write_complete (*spi_flash_write_complete_fn_ptr)

typedef PMCFW_ERROR (*spi_flash_subsector_erase_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, UINT8 *addr_ptr);
EXTERN spi_flash_subsector_erase_fn_ptr_type spi_flash_subsector_erase_fn_ptr;
#define spi_flash_subsector_erase (*spi_flash_subsector_erase_fn_ptr)

typedef PMCFW_ERROR (*spi_flash_sector_erase_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, UINT8 *addr_ptr);
EXTERN spi_flash_sector_erase_fn_ptr_type spi_flash_sector_erase_fn_ptr;
#define spi_flash_sector_erase (*spi_flash_sector_erase_fn_ptr)
...
typedef PMCFW_ERROR (*spi_flash_erase_complete_fn_ptr_type)(UINT8 port_id, UINT8 cs_id, BOOL *complete);
EXTERN spi_flash_erase_complete_fn_ptr_type spi_flash_erase_complete_fn_ptr;
#define spi_flash_erase_complete (*spi_flash_erase_complete_fn_ptr)
